...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /////*     initialize view   */////
        _backImageView = findViewById(R.id.id_back_ImageView);
...
*/
      ...
      /*  _nameEditText.setCompoundDrawablesWithIntrinsicBounds(AppCompatResources.getDrawable(SignUp .this,R.drawable.ic_profile),null,null,null);
        ...
        _emailEditText.setCompoundDrawablesWithIntrinsicBounds(AppCompatResources.getDrawable(SignUp .this,R.drawable.ic_email),null,null,null);
        _emailEditText.setCompoundDrawablePadding(8);
        _passwordEditText.setCompoundDrawablesWithIntrinsicBounds(AppCompatResources.getDrawable(SignUp .this,R.drawable.ic_password_lock),null,null,null);
        _passwordEditText.setCompoundDrawablePadding(8);
        final int sdk = android.os.Build.VERSION.SDK_INT;
        if(sdk<android.os.Build.VERSION_CODES.JELLY_BEAN)

        {
            _lineView.setBackgroundDrawable(ContextCompat.getDrawable(SignUp.this, R.drawable.line_view));
            _lineView2.setBackgroundDrawable(ContextCompat.getDrawable(SignUp.this, R.drawable.line_view));
        } else
